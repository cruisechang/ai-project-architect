...
func buildArtifacts(opts config.CreateOptions) ([]string, []plannedFile) {
	...
	case "claude-code":
		...
		files = append(files,
			...
			plannedFile{RelPath: "skills/apa-integration/SKILL.md", TemplateName: "skill_md.tmpl", Mode: 0o644},
			plannedFile{RelPath: "skills/apa-devops/SKILL.md", TemplateName: "skill_md.tmpl", Mode: 0o644},
			plannedFile{RelPath: "skills/apa-debug/SKILL.md", TemplateName: "skill_md.tmpl", Mode: 0o644},
		)
	default:
